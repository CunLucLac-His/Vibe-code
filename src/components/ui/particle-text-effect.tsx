...
const DEFAULT_WORDS = ["Tiến Trung"]
const DEFAULT_INTERVAL_FRAMES = 240
...
export function ParticleTextEffect({
  ...
  const animate = () => {
    ...
    // Auto-advance words once through the list, then stop (no looping back to the start)
    frameCountRef.current++
    if (
      frameCountRef.current % intervalFrames === 0 &&
